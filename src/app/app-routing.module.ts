...
const routes: Routes = [
  { path: 'patient', loadChildren: './patienttabs/patienttabs.module#PatienttabsPageModule' },
  { path: 'parent', loadChildren: './parenttabs/parenttabs.module#ParenttabsPageModule' },
